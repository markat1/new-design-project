    ...
    QuoteLine[] Lines)
{
    ...
    [
        new("Q-2418", "Featherstonehaugh-Villanueva International Systems",
            ...
            "Priser på rammeaftale 2027", "Hej Bartholomew — her er priserne på rammeaftalen, som aftalt på mødet. Sig til hvis I vil have licenserne opgjort anderledes.", QuoteStatus.Viewed, "2026-09-02",
        ...
        new("Q-2417", "Vela Robotics", "procurement@velarobotics.com",
            "Tilbud: servicepakke Q4", "Priserne gælder til udgangen af oktober.", QuoteStatus.Accepted, "2026-09-01",
        ...
        new("Q-2415", "Ferrous Manufacturing Group", "einkauf@ferrous-mfg.de",
            "Angebot: Wartungsvertrag", "Guten Tag — anbei die Preise für den Wartungsvertrag.", QuoteStatus.Viewed, "2026-08-24",
        ...
        new("Q-2413", "Kestrel Analytics", "finance@kestrel.io",
            "Renewal pricing 2027", "Same terms as last year, with onboarding included this time.", QuoteStatus.Accepted, "2026-08-19",
            [new("Platform, årligt", 1, 61_000m), new("Onboarding", 1, 12_000m)]),

        new("Q-2412", "Ondrej Systems", "dev@acme.io",
            "Lille tilkøb", "Kun de to ekstra sæder — resten er uændret.", QuoteStatus.Declined, "2026-08-14",
            [new("Ekstra sæde", 2, 1_445m)]),

        new("Q-2411", "Bright Harbour Logistics", "ops@brightharbour.co",
            "Fragtpriser, revideret", "Fragtpriserne er justeret efter den nye rute. Håndteringen er uændret.", QuoteStatus.Sent, "2026-08-11",
